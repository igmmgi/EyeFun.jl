...
function _read_smi_txt(path::String)
    ...
    gxL = fill(Float32(NaN), n_samples)
    gyL = fill(Float32(NaN), n_samples)
    paL = fill(Float32(NaN), n_samples)
    gxR = fill(Float32(NaN), n_samples)
    gyR = fill(Float32(NaN), n_samples)
    paR = fill(Float32(NaN), n_samples)
    pupxL = fill(Float32(NaN), n_samples)
    pupyL = fill(Float32(NaN), n_samples)
    pupxR = fill(Float32(NaN), n_samples)
    pupyR = fill(Float32(NaN), n_samples)
...
function _read_smi_idf(path::String)
    ...
    gxL = fill(Float32(NaN), n_sub_records)
    gyL = fill(Float32(NaN), n_sub_records)
    paL = fill(Float32(NaN), n_sub_records)
    gxR = fill(Float32(NaN), n_sub_records)
    gyR = fill(Float32(NaN), n_sub_records)
    paR = fill(Float32(NaN), n_sub_records)
    pupxL = fill(Float32(NaN), n_sub_records)
    pupyL = fill(Float32(NaN), n_sub_records)
    pupxR = fill(Float32(NaN), n_sub_records)
    pupyR = fill(Float32(NaN), n_sub_records)
    diaxL = fill(Float32(NaN), n_sub_records)
    diayL = fill(Float32(NaN), n_sub_records)
    diaxR = fill(Float32(NaN), n_sub_records)
    diayR = fill(Float32(NaN), n_sub_records)
    crxL = fill(Float32(NaN), n_sub_records)
    cryL = fill(Float32(NaN), n_sub_records)
    crxR = fill(Float32(NaN), n_sub_records)
    cryR = fill(Float32(NaN), n_sub_records)
